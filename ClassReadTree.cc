...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   static const Int_t kMaxg1xcl = 7;

   static const Int_t kMaxg1ycl = 10;

   static const Int_t kMaxg2xcl = 10;

   static const Int_t kMaxg2ycl = 11;

   static const Int_t kMaxg3xcl = 14;

   static const Int_t kMaxg3ycl = 12;

   static const Int_t kMaxg4xcl = 1;

   static const Int_t kMaxg4ycl = 1;

   static const Int_t kMaxgCMSLGcl = 1;

   static const Int_t kMaxg1T2Padscl = 1;

   static const Int_t kMaxg2T2Padscl = 1;

   static const Int_t kMaxg1T2Stripscl = 1;

   static const Int_t kMaxg2T2Stripscl = 1;

   static const Int_t kMaxgCTLBottomLeftxcl = 1;

   static const Int_t kMaxgCTLBottomLeftycl = 1;

   static const Int_t kMaxgCTLMiddleLeftycl = 1;

   static const Int_t kMaxgCTLTopLeftxcl = 1;

   static const Int_t kMaxgCTLTopLeftycl = 1;

   static const Int_t kMaxgCTLTopMiddlexcl = 1;

   static const Int_t kMaxgCTLTopRightxcl = 1;

   static const Int_t kMaxgCTLTopRightycl = 1;
