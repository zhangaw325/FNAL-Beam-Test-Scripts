...
void SelectTrackerEvents()
{
    ...
    TH1F* h_Strip_g2xcl=new TH1F("h_Strip_g2xcl","",100, 0, 255);h_Strip_g2xcl->SetXTitle("Cluster position in terms of strip");h_Strip_g2xcl->SetYTitle("Frequency");h_Strip_g2xcl->SetTitleSize(0.04,"XY");h_Strip_g2xcl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_g2ycl=new TH1F("h_Strip_g2ycl","",100, 0,255);h_Strip_g2ycl->SetXTitle("Cluster position in terms of strip");h_Strip_g2ycl->SetYTitle("Frequency");h_Strip_g2ycl->SetTitleSize(0.04,"XY");h_Strip_g2ycl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_g3xcl=new TH1F("h_Strip_g3xcl","",100, 0, 255);h_Strip_g3xcl->SetXTitle("Cluster position in terms of strip");h_Strip_g3xcl->SetYTitle("Frequency");h_Strip_g3xcl->SetTitleSize(0.04,"XY");h_Strip_g3xcl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_g3ycl=new TH1F("h_Strip_g3ycl","",100, 0, 255);h_Strip_g3ycl->SetXTitle("Cluster position in terms of strip");h_Strip_g3ycl->SetYTitle("Frequency");h_Strip_g3ycl->SetTitleSize(0.04,"XY");h_Strip_g3ycl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_g1xcl=new TH1F("h_Strip_g1xcl","",100, 0, 255);h_Strip_g1xcl->SetXTitle("Cluster position in terms of strip");h_Strip_g1xcl->SetYTitle("Frequency");h_Strip_g1xcl->SetTitleSize(0.04,"XY");h_Strip_g1xcl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_g1ycl=new TH1F("h_Strip_g1ycl","",100, 0, 255);h_Strip_g1ycl->SetXTitle("Cluster position in terms of strip");h_Strip_g1ycl->SetYTitle("Frequency");h_Strip_g1ycl->SetTitleSize(0.04,"XY");h_Strip_g1ycl->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_sCMSNS2LC1=new TH1F("h_Strip_sCMSNS2LC1","",100, 0, 255);h_Strip_sCMSNS2LC1->SetXTitle("Cluster position in terms of strip");h_Strip_sCMSNS2LC1->SetYTitle("Frequency");h_Strip_sCMSNS2LC1->SetTitleSize(0.04,"XY");h_Strip_sCMSNS2LC1->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_sCMSNS2LC2=new TH1F("h_Strip_sCMSNS2LC2","",100, 0, 255);h_Strip_sCMSNS2LC2->SetXTitle("Cluster position in terms of strip");h_Strip_sCMSNS2LC2->SetYTitle("Frequency");h_Strip_sCMSNS2LC2->SetTitleSize(0.04,"XY");h_Strip_sCMSNS2LC2->SetLabelSize(0.04,"XY");
    TH1F* h_Strip_sCMSNS2LC3=new TH1F("h_Strip_sCMSNS2LC3","",100, 0, 255);h_Strip_sCMSNS2LC3->SetXTitle("Cluster position in terms of strip");h_Strip_sCMSNS2LC3->SetYTitle("Frequency");h_Strip_sCMSNS2LC3->SetTitleSize(0.04,"XY");h_Strip_sCMSNS2LC3->SetLabelSize(0.04,"XY");
